...
#define EXTERNAL_BTN_PORT	GPIOA
#define EXTERNAL_BTN_PIN	GPIO_PIN_0
...
void gpio_pa0_interrupt_init(void); // deal with PA0 where one end of the external button will be connected
