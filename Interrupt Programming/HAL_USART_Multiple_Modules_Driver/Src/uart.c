...
void uart3_init(void)
{
	...
	//Enable UART pins clock access UART3 is connected to PD8 and PD9 on this board
	...
	//Configure UART TX module
	h_uart_3.Instance = USART3;
	h_uart_3.Init.BaudRate = 115200;
	h_uart_3.Init.WordLength = UART_WORDLENGTH_8B;
	h_uart_3.Init.StopBits = UART_STOPBITS_1;
	h_uart_3.Init.Parity = UART_PARITY_NONE;
	h_uart_3.Init.Mode = UART_MODE_TX_RX;
	h_uart_3.Init.HwFlowCtl = UART_HWCONTROL_NONE;
	h_uart_3.Init.OverSampling = UART_OVERSAMPLING_16;

	HAL_UART_Init(&h_uart_3);
}
